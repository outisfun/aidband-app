          ...
          <ul>
            <li className="ab-header__nav__item is--current">
              <Link to="./hospitals">
                ...
                <path d="M17 8H13.8L11.4 15L6.6 1L4.2 8H1" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <li className="ab-header__nav__item item--truck">
              <Link to="./hospitals">
                ...
                <path d="M58.334 12.5H45.834V23.3333H58.334V12.5Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M58.334 16.6667H61.6673L64.1673 19.1667V23.3334H58.334V16.6667Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M49.5833 27.4999C50.7339 27.4999 51.6667 26.5672 51.6667 25.4166C51.6667 24.266 50.7339 23.3333 49.5833 23.3333C48.4327 23.3333 47.5 24.266 47.5 25.4166C47.5 26.5672 48.4327 27.4999 49.5833 27.4999Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M60.4173 27.4999C61.5679 27.4999 62.5007 26.5672 62.5007 25.4166C62.5007 24.266 61.5679 23.3333 60.4173 23.3333C59.2667 23.3333 58.334 24.266 58.334 25.4166C58.334 26.5672 59.2667 27.4999 60.4173 27.4999Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g><defs>
                <clipPath id="clip0">
